...
WD.py does not start the WebDriver server automaticalliy, you may use `Macaca <http://macacajs.github.io/macaca/>`_ to start a WebDriver server and run the tests after.
